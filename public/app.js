angular.module('MyApp', ['ngResource', 'ngMessages', 'ngAnimate', 'toastr', 'ui.router', 'satellizer', 'ui.bootstrap', 'ui.bootstrap.datetimepicker','angular-timeline','ngMap','ngGPlaces','ngRaven'])
